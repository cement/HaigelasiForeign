package com.haigelasi.mall.foreign.wxpaysdk;
...
//        }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        return requestWithoutCert(urlSuffix,reqData,config.getHttpConnectTimeoutMs(),config.getHttpReadTimeoutMs());
    }
    ...
    public String requestWithCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        return requestWithCert(urlSuffix,reqData,config.getHttpConnectTimeoutMs(),config.getHttpReadTimeoutMs());
    }
    /**
